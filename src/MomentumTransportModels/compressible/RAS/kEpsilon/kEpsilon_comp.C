...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> kEpsilon_comp<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> kEpsilon_comp<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
