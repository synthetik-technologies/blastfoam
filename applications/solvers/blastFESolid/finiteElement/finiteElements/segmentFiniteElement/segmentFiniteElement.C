...
namespace finiteElements
{
    ...
    defineFE(seg2); addFE(seg2, msh, 1);
    defineFE(seg3); addFE(seg3, msh, 8);
    defineFE(seg4); addFE(seg4, msh, 26);
    defineFE(seg5); addFE(seg5, msh, 27);
    defineFE(seg6); addFE(seg6, msh, 28);
    defineFE(seg7); addFE(seg7, msh, 62);
    defineFE(seg8); addFE(seg8, msh, 63);
    defineFE(seg9); addFE(seg9, msh, 64);
    defineFE(seg10); addFE(seg10, msh, 65);
    defineFE(seg11); addFE(seg11, msh, 66);
}
}
    ...
    w_(this->nNodes(), 0.0)
{
    ...
    {
        // GaussianQuadrature::calcLobatto(x, w_);
