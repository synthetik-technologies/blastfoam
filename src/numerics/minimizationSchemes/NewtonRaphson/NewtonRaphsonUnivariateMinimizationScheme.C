...
#include "NewtonRaphsonUnivariateMinimizationScheme.H"
...
Foam::univariateMinimizationSchemes::NewtonRaphson::NewtonRaphson
(
...
Foam::scalar Foam::univariateMinimizationSchemes::NewtonRaphson::minimize
(
    const scalar x,
    const scalar xLow,
    const scalar xHigh,
