...
namespace finiteElements
{
    ...
    defineFE(wedge6); addFE(wedge6, msh, 6);
    defineFE(wedge18); addFE(wedge18, msh, 13);
    defineFE(wedge40); addFE(wedge40, msh, 90);
    defineFE(wedge75); addFE(wedge75, msh, 91);
    defineFE(wedge126); addFE(wedge126, msh, 106);
    defineFE(wedge196); addFE(wedge196, msh, 107);
    defineFE(wedge288); addFE(wedge288, msh, 107);
    defineFE(wedge405); addFE(wedge405, msh, 109);
    defineFE(wedge550); addFE(wedge550, msh, 110);
}
}
...
) const
{
    ...
    List<scalar> shape_s(seg_.calcShape(pt.y()));
...
) const
{
    ...
    seg_.calcDShape(pt.x(), shape_s, dshape_s);
