...
template<class SourcePatch, class TargetPatch>
bool Foam::newAMIMethod<SourcePatch, TargetPatch>::initialise
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newAMIMethod<SourcePatch, TargetPatch>::writeIntersectionOBJ
(
    const scalar area,
    const face& f1,
    const face& f2,
...
template<class SourcePatch, class TargetPatch>
void Foam::newAMIMethod<SourcePatch, TargetPatch>::resetTree()
{
...
template<class SourcePatch, class TargetPatch>
Foam::label Foam::newAMIMethod<SourcePatch, TargetPatch>::findTargetFace
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newAMIMethod<SourcePatch, TargetPatch>::appendNbrFaces
(
    const label facei,
...
template<class SourcePatch, class TargetPatch>
Foam::scalar Foam::newAMIMethod<SourcePatch, TargetPatch>::maxWalkAngle() const
{
    return degToRad(89);
}
...
template<class SourcePatch, class TargetPatch>
Foam::newAMIMethod<SourcePatch, TargetPatch>::newAMIMethod
(
