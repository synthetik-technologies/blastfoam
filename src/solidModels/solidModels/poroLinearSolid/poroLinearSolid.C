...
defineTypeNameAndDebug(poroLinearSolid, 0);
addToRunTimeSelectionTable(solidModel, poroLinearSolid, dictionary);


// * * * * * * * * * * *  Private Member Functions * * * * * * * * * * * * * //

bool poroLinearSolid::converged
(
    const int iCorr,
