...
Foam::basicChemistryModel::basicChemistryModel(basicThermoModel& thermo)
:
    IOdictionary
    (
        IOobject
        (
            IOobject::groupName("chemistryProperties", thermo.name()),
            thermo.p().time().constant(),
            thermo.p().mesh(),
    ...
    (
        IOobject
        (
            IOobject::groupName("deltaTChem", thermo.name()),
            mesh().time().constant(),
            mesh(),
            IOobject::NO_READ,
            IOobject::NO_WRITE
