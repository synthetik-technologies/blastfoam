...
#include "linearPressureDisplacementSolid.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(linearPressureDisplacementSolid, 0);
addToRunTimeSelectionTable
(
    solidModel, linearPressureDisplacementSolid, dictionary
);
