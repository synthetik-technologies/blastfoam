...
namespace Foam
{
    defineTypeNameAndDebug(polyMeshHexRefiner, 0);
    addToRunTimeSelectionTable(polyMeshRefiner, polyMeshHexRefiner, polyMesh);
    addToRunTimeSelectionTable(polyMeshRefiner, polyMeshHexRefiner, dictionary);

}

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::polyMeshHexRefiner::calculateProtectedCells
(
...
Foam::labelList Foam::polyMeshHexRefiner::selectRefineCells
(
...
void Foam::polyMeshHexRefiner::checkEightAnchorPoints
(
...
bool Foam::polyMeshHexRefiner::refine
(
