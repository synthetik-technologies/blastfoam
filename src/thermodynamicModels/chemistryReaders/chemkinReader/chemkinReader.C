...
namespace Foam
{
    addChemistryReaderType(chemkinReader, sutherlandTransportjanafperfectGasblastSpecie);
}
    ...
    switch (rType)
    {
        case irreversible:
        {
            ...
            (
                ...
                <Reaction, sutherlandTransportjanafperfectGasblastSpecie, ReactionRateType>
                (
                    ReactionProxy<sutherlandTransportjanafperfectGasblastSpecie>
                    (
                        speciesTable_,
                        lhs.shrink(),
                        rhs.shrink(),
            ...
            if (rType == nonEquilibriumReversible)
            {
                ...
                (
                    new NonEquilibriumReversibleReaction
                        <Reaction, sutherlandTransportjanafperfectGasblastSpecie, ArrheniusReactionRate>
                    (
                        ReactionProxy<sutherlandTransportjanafperfectGasblastSpecie>
                        (
                            speciesTable_,
        ...
        case thirdBodyArrhenius:
        {
            if (rType == nonEquilibriumReversible)
            {
                ...
                (
                    ...
                    <
                        Reaction,
                        sutherlandTransportjanafperfectGasblastSpecie,
...
{
    Reaction<sutherlandTransportjanafperfectGasblastSpecie>::TlowDefault = 0;
    Reaction<sutherlandTransportjanafperfectGasblastSpecie>::ThighDefault = great;
