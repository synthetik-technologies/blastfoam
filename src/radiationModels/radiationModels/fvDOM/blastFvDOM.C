...
void Foam::radiationModels::blastFvDOM::initialise()
{
    // 3D
    if (mesh_.nGeometricD() == 3)
    {
        ...
        for (label n = 1; n <= nTheta_; n++)
        {
            for (label m = 1; m <= 4*nPhi_; m++)
            {
                ...
                (
                    i,
                    new blastRadiativeIntensityRay
                    (
                        *this,
                        mesh_,
                        phii,
...
Foam::radiationModels::blastFvDOM::blastFvDOM
(
...
bool Foam::radiationModels::blastFvDOM::read()
{
...
void Foam::radiationModels::blastFvDOM::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiationModels::blastFvDOM::Rp() const
{
...
Foam::radiationModels::blastFvDOM::Ru() const
{
...
void Foam::radiationModels::blastFvDOM::updateBlackBodyEmission()
{
    for (label j=0; j < nLambda_; j++)
    {
...
void Foam::radiationModels::blastFvDOM::updateG()
{
...
void Foam::radiationModels::blastFvDOM::setRayIdLambdaId
(
    const word& name,
    label& rayId,
    label& lambdaId
