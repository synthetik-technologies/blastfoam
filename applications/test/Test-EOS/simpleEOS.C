...
namespace Foam
{
    defineTypeNameAndDebug(simpleEOS, 0);
    defineRunTimeSelectionTable(simpleEOS, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::simpleEOS::simpleEOS()
{}
...
Foam::autoPtr<Foam::simpleEOS> Foam::simpleEOS::New
(
...
Foam::word Foam::simpleEOS::readThermoType(const dictionary& dict)
{
    return word
    (
...
Foam::wordList Foam::simpleEOS::splitThermoName
(
