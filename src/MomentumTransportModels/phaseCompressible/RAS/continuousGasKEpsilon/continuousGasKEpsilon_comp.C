...
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::continuousGasKEpsilon_comp
(
...
template<class BasicMomentumTransportModel>
bool continuousGasKEpsilon_comp<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void continuousGasKEpsilon_comp<BasicMomentumTransportModel>::correctNut()
{
    kEpsilon_comp<BasicMomentumTransportModel>::correctNut();
...
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::liquidTurbulence() const
{
...
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::nuEff() const
{
...
template<class BasicMomentumTransportModel>
tmp<Foam::volScalarField>
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::rhoEff() const
{
    const phaseModel& gas = refCast<const phaseModel>(this->properties());
    const phaseSystem& fluid = gas.fluid();
    const phaseModel& liquid = fluid.otherPhase(gas);
...
template<class BasicMomentumTransportModel>
tmp<volScalarField>
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::phaseTransferCoeff() const
{
    const volVectorField& U = this->U_;
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::kSource() const
{
    const momentumTransportModel& liquidTurbulence = this->liquidTurbulence();
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::epsilonSource() const
{
    const momentumTransportModel& liquidTurbulence = this->liquidTurbulence();
    const volScalarField phaseTransferCoeff(this->phaseTransferCoeff());
...
continuousGasKEpsilon_comp<BasicMomentumTransportModel>::sigma() const
{
