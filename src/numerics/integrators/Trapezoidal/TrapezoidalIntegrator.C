...
Foam::TrapezoidalIntegrator<Type, Adapt>::TrapezoidalIntegrator
(
...
template<class Type, class Adapt>
Type Foam::TrapezoidalIntegrator<Type, Adapt>::integrate_
(
    const scalar dx,
    const Type& f0,
    const Type& f1
...
template<class Type, class Adapt>
Type Foam::TrapezoidalIntegrator<Type, Adapt>::integrate
(
    const scalar X0,
    const scalar X1,
    const label li
