...
#include "newCellLimitedGrad.H"
#include "BarthJaspersenGradientLimiter.H"
#include "MichalakGoochGradientLimiter.H"
...
namespace Foam
{
    namespace fv
    {
        ...
        using cellLimitedGrad = newCellLimitedGrad<Type, Limiter>;
    }
}
makeFvLimitedGradScheme(cellLimited, BarthJaspersen)
makeFvLimitedGradScheme(cellLimited, MichalakGooch)
