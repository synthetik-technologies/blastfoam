...
namespace Foam
{
    defineTypeNameAndDebug(oversetCellVolumeWeightMethod, 0);
    addToRunTimeSelectionTable
    (
        oversetMeshToMeshMethod,
        oversetCellVolumeWeightMethod,
        meshComponents
    );
}
...
bool Foam::oversetCellVolumeWeightMethod::findInitialSeeds
(
...
void Foam::oversetCellVolumeWeightMethod::setNextCells
(
    label& startSeedI,
    label& srcCelli,
    label& tgtCelli,
...
Foam::oversetCellVolumeWeightMethod::oversetCellVolumeWeightMethod
(
    const polyMesh& src,
    const polyMesh& tgt
)
...
void Foam::oversetCellVolumeWeightMethod::calculate
(
