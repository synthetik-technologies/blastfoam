...
void Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::calcAddressing
(
...
template<class SourcePatch, class TargetPatch>
bool Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::processSourceFace
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::setNextFaces
(
    label& startSeedI,
    label& srcFacei,
    label& tgtFacei,
...
template<class SourcePatch, class TargetPatch>
Foam::scalar Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::interArea
(
    const label srcFacei,
...
template<class SourcePatch, class TargetPatch>
void Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::
...
)
{
    ...
    if (debug)
    {
        Pout<< "newFaceAreaWeightAMI: restarting search on "
...
template<class SourcePatch, class TargetPatch>
Foam::scalar
Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::minWeight() const
{
...
template<class SourcePatch, class TargetPatch>
Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::newFaceAreaWeightAMI
(
...
:
    newAMIMethod<SourcePatch, TargetPatch>
    (
        srcPatch,
        tgtPatch,
        srcMagSf,
...
template<class SourcePatch, class TargetPatch>
void Foam::newFaceAreaWeightAMI<SourcePatch, TargetPatch>::calculate
(
