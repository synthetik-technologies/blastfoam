...
namespace finiteElements
{
    ...
    defineFE(pyramid5); addFE(pyramid5, msh, 7);
    defineFE(pyramid14); addFE(pyramid14, msh, 14);
    defineFE(pyramid30); addFE(pyramid30, msh, 118);
    defineFE(pyramid55); addFE(pyramid55, msh, 119);
    defineFE(pyramid91); addFE(pyramid91, msh, 120);
    defineFE(pyramid140); addFE(pyramid140, msh, 121);
    defineFE(pyramid204); addFE(pyramid204, msh, 122);
    defineFE(pyramid285); addFE(pyramid285, msh, 123);
    defineFE(pyramid385); addFE(pyramid385, msh, 124);
}
}
