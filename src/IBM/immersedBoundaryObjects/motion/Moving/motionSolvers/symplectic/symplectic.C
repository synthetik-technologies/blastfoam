...
namespace immersedBoundaryObjectMotionSolvers
{
    ...
    addToRunTimeSelectionTable(immersedBoundaryObjectMotionSolver, symplectic, dictionary);
}
}
...
Foam::immersedBoundaryObjectMotionSolvers::symplectic::symplectic
(
...
void Foam::immersedBoundaryObjectMotionSolvers::symplectic::solve
(
    bool firstIter,
