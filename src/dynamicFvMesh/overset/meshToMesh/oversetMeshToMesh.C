...
namespace Foam
{
    defineTypeNameAndDebug(oversetMeshToMesh, 0);

    template<>
    const char* Foam::NamedEnum
    <
        Foam::oversetMeshToMesh::interpolationMethod,
        4
    >::names[] =
    {
        "direct",
    ...
    const char* Foam::NamedEnum
    <
        Foam::oversetMeshToMesh::procMapMethod,
        2
    >::names[] =
    {
        "AABB",
...
const Foam::NamedEnum<Foam::oversetMeshToMesh::interpolationMethod, 4>
Foam::oversetMeshToMesh::interpolationMethodNames_;

const Foam::NamedEnum<Foam::oversetMeshToMesh::procMapMethod, 2>
Foam::oversetMeshToMesh::procMapMethodNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<>
void Foam::oversetMeshToMesh::mapAndOpSrcToTgt
(
...
template<>
void Foam::oversetMeshToMesh::mapAndOpTgtToSrc
(
    const AMIInterpolation& AMI,
...
Foam::labelList Foam::oversetMeshToMesh::maskCells
(
    const polyMesh& src,
    const polyMesh& tgt
) const
...
void Foam::oversetMeshToMesh::normaliseWeights
(
...
void Foam::oversetMeshToMesh::calcAddressing
(
...
{
    autoPtr<oversetMeshToMeshMethod> methodPtr
    (
        oversetMeshToMeshMethod::New
        (
            methodName,
            src,
            tgt
...
Foam::oversetMeshToMesh::interpolationMethodAMI(const interpolationMethod method)
{
    switch (method)
    {
        case imDirect:
...
void Foam::oversetMeshToMesh::calculatePatchAMIs(const word& AMIMethodName)
{
    if (!patchAMIs_.empty())
    {
        FatalErrorInFunction
...
void Foam::oversetMeshToMesh::constructNoCuttingPatches
(
    const word& methodName,
...
void Foam::oversetMeshToMesh::constructFromCuttingPatches
(
    const word& methodName,
    const word& AMIMethodName,
...
Foam::oversetMeshToMesh::oversetMeshToMesh
(
    const polyMesh& src,
    const polyMesh& tgt,
