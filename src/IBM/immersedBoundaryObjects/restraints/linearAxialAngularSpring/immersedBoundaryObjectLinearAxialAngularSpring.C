...
#include "immersedBoundaryObjectLinearAxialAngularSpring.H"
...
Foam::immersedBoundaryObjectRestraints::linearAxialAngularSpring::
linearAxialAngularSpring
(
    const polyMesh& mesh,
    const word& name,
...
void
Foam::immersedBoundaryObjectRestraints::linearAxialAngularSpring::restrain
(
...
bool Foam::immersedBoundaryObjectRestraints::linearAxialAngularSpring::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void Foam::immersedBoundaryObjectRestraints::linearAxialAngularSpring::write
(
    Ostream& os
) const
{
