...
#include "fixedValueImmersedBoundaryFvPatchField.H"
...
template<class Type>
void Foam::fixedValueImmersedBoundaryFvPatchField<Type>::updateCoeffs() const
{
    this->values_ = value_;
}
...
template<class Type>
void Foam::fixedValueImmersedBoundaryFvPatchField<Type>::setValues()
{
//     this->setInternal(value_);
}
