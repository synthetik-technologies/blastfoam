...
Foam::labelList Foam::newFvMeshSubset::subset
(
    const label nElems,
...
Foam::labelList Foam::newFvMeshSubset::getCellsToRemove
(
...
Foam::newFvMeshSubset::newFvMeshSubset(const fvMesh& baseMesh)
:
    baseMesh_(baseMesh),
    newFvMeshSubsetPtr_(nullptr),
    pointMap_(0),
    faceMap_(0),
    cellMap_(0),
    patchMap_(0),
...
)
{
    ...
    // Delete any old mesh
    newFvMeshSubsetPtr_.clear();
    // Make a new mesh
    newFvMeshSubsetPtr_.reset
    (
        new fvMesh
        (
            IOobject
...
Foam::labelList Foam::newFvMeshSubset::getExposedFaces
(
    const labelList& region,
    const label currentRegion,
...
bool Foam::newFvMeshSubset::hasSubMesh() const
{
    return newFvMeshSubsetPtr_.valid();
}


const Foam::fvMesh& Foam::newFvMeshSubset::subMesh() const
{
    checkCellSubset();
...
Foam::fvMesh& Foam::newFvMeshSubset::subMesh()
{
    checkCellSubset();
...
const Foam::labelList& Foam::newFvMeshSubset::pointMap() const
{
    checkCellSubset();
...
const Foam::labelList& Foam::newFvMeshSubset::faceMap() const
{
    checkCellSubset();
...
const Foam::labelList& Foam::newFvMeshSubset::faceFlipMap() const
{
...
const Foam::labelList& Foam::newFvMeshSubset::cellMap() const
{
    checkCellSubset();
...
const Foam::labelList& Foam::newFvMeshSubset::patchMap() const
{
    checkCellSubset();
