...
namespace finiteElements
{
    ...
    defineFE(quad4); addFE(quad4, msh, 3);
    defineFE(quad9); addFE(quad9, msh, 10);
    defineFE(quad16); addFE(quad16, msh, 36);
    defineFE(quad25); addFE(quad25, msh, 37);
    defineFE(quad36); addFE(quad36, msh, 38);
    defineFE(quad49); addFE(quad49, msh, 47);
    defineFE(quad64); addFE(quad64, msh, 48);
    defineFE(quad81); addFE(quad81, msh, 49);
    defineFE(quad100); addFE(quad100, msh, 50);
    defineFE(quad121); addFE(quad121, msh, 51);
}
}
