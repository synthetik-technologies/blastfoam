...
#include "blastWallHeatTransferFvPatchScalarField.H"
...
void Foam::blast::wallHeatTransferFvPatchScalarField::autoMap
(
...
void Foam::blast::wallHeatTransferFvPatchScalarField::rmap
(
...
void Foam::blast::wallHeatTransferFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    valueFraction() =
        ...
        (
            1.0
          + ttm.kappaEff(patchi)*patch().deltaCoeffs()/alphaWall_
        );
...
void Foam::blast::wallHeatTransferFvPatchScalarField::write(Ostream& os) const
{
