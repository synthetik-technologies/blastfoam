...
template<class Type>
tmp<GeometricField<Type, fvPatchField, volMesh>> blastFvMeshSubset::interpolate
(
...
template<class Type>
tmp<GeometricField<Type, fvsPatchField, surfaceMesh>> blastFvMeshSubset::interpolate
(
...
template<class Type>
tmp<GeometricField<Type, pointPatchField, pointMesh>> blastFvMeshSubset::interpolate
(
...
template<class Type>
tmp<DimensionedField<Type, volMesh>> blastFvMeshSubset::interpolate
(
