...
#include "unsTotalLagrangianTotalDisplacementSolid.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(unsTotalLagrangianTotalDisplacementSolid, 0);
addToRunTimeSelectionTable
(
    solidModel, unsTotalLagrangianTotalDisplacementSolid, dictionary
);
...
scalar unsTotalLagrangianTotalDisplacementSolid::residual
(
...
void unsTotalLagrangianTotalDisplacementSolid::readDict()
{
    solidModel::readDict();
