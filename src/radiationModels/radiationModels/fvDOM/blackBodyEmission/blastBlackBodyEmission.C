...
#include "blastBlackBodyEmission.H"
...
Foam::radiationModels::blastBlackBodyEmission::emissivePowerTable
(
    IStringStream
    (
        "("
...
Foam::radiationModels::blastBlackBodyEmission::blastBlackBodyEmission
(
    const label nLambda,
...
Foam::scalar Foam::radiationModels::blastBlackBodyEmission::fLambdaT
(
...
void Foam::radiationModels::blastBlackBodyEmission::correct
(
    const label lambdaI,
    const Vector2D<scalar>& band
)
