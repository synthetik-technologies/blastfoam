...
const Foam::word
Foam::radiationModels::blastRadiativeIntensityRay::intensityPrefix
(
    "ILambda"
);
...
Foam::radiationModels::blastRadiativeIntensityRay::blastRadiativeIntensityRay
(
    const blastFvDOM& dom,
    const fvMesh& mesh,
    const scalar phi,
    const scalar theta,
    ...
    const blastBlackBodyEmission& blackBody,
    const label rayId
)
:
    dom_(dom),
...
Foam::scalar Foam::radiationModels::blastRadiativeIntensityRay::correct()
{
...
void Foam::radiationModels::blastRadiativeIntensityRay::addIntensity()
{
