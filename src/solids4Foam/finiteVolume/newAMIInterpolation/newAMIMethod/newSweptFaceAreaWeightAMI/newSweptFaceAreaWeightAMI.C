...
const Foam::scalar Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::
...
void Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::writeCutTrisVTK
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::writeFaceOBJ
(
    const face& f,
    const pointField& ps,
    const string& name
...
template<class SourcePatch, class TargetPatch>
void Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::
writeProjectionOBJ
(
    const label srcN,
...
template<class SourcePatch, class TargetPatch>
Foam::label
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::getSourceProjection
(
...
template<class SourcePatch, class TargetPatch>
Foam::plane
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::getCutPlane
(
    const point& p0,
    const point& p1,
    const vector& n0,
...
template<class SourcePatch, class TargetPatch>
Foam::scalar
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::interArea
(
...
) const
{
    ...
    if (debugPrint)
    {
        const scalar standardAreaMag =
            newFaceAreaWeightAMI<SourcePatch, TargetPatch>::interArea
            (
                srcFacei,
                tgtFacei
            );
...
template<class SourcePatch, class TargetPatch>
Foam::scalar
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::minWeight() const
{
    return small;
}
...
template<class SourcePatch, class TargetPatch>
Foam::scalar
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::maxWalkAngle() const
{
    return degToRad(180);
}
...
template<class SourcePatch, class TargetPatch>
Foam::newSweptFaceAreaWeightAMI<SourcePatch, TargetPatch>::
