...
Foam::scalar Foam::blendingMethods::hyperbolic::f1i
(
    const label celli,
    const phaseModel& phase1,
    const phaseModel& phase2
        ...
        (
          ...
          + tanh
            (
               ...
               *(phase2[celli] - minContinuousAlpha_[phase2.name()].value())
            )
        )/2;
}
...
Foam::scalar Foam::blendingMethods::hyperbolic::f2i
(
    const label celli,
    const phaseModel& phase1,
    const phaseModel& phase2
    ...
    return
        (
          ...
          + tanh
            (
                (4/transitionAlphaScale_.value())
               *(phase1[celli] - minContinuousAlpha_[phase1.name()].value())
            )
        )/2;
}
