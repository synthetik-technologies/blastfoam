...
#include "blastExternalWallHeatFluxTemperatureFvPatchScalarField.H"
...
Foam::blast::externalWallHeatFluxTemperatureFvPatchScalarField::
...
void Foam::blast::externalWallHeatFluxTemperatureFvPatchScalarField::autoMap
(
...
void Foam::blast::externalWallHeatFluxTemperatureFvPatchScalarField::rmap
(
...
void
Foam::blast::externalWallHeatFluxTemperatureFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::blast::externalWallHeatFluxTemperatureFvPatchScalarField::write
(
    Ostream& os
) const
{
