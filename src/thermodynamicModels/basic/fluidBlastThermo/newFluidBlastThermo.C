...
Foam::autoPtr<Foam::fluidBlastThermo> Foam::fluidBlastThermo::NewBasic
(
...
Foam::autoPtr<Foam::fluidBlastThermo> Foam::fluidBlastThermo::NewDetonating
(
    const word& phaseName,
    volScalarField& p,
    volScalarField& rho,
...
Foam::autoPtr<Foam::fluidBlastThermo> Foam::fluidBlastThermo::NewMulticomponent
(
    const word& phaseName,
    volScalarField& p,
    volScalarField& rho,
...
Foam::autoPtr<Foam::fluidBlastThermo> Foam::fluidBlastThermo::NewReacting
(
    const word& phaseName,
    volScalarField& p,
    volScalarField& rho,
...
//     }
    else
    {
        FatalErrorInFunction
            ...
            << "Valid " << fluidBlastThermo::typeName << " types are:" << nl
            << "basic" << nl
            << "detonating" << nl
            << "multicomponent" << nl
//             << "reacting" << nl
    ...
    return autoPtr<fluidBlastThermo>();
}
