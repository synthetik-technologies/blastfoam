...
Foam::tmp<Foam::volScalarField> Foam::basicThermoModel::alpha() const
{
    return alpha_;
}
...
Foam::basicThermoModel::alpha(const label patchi) const
{
    return alpha_.boundaryField()[patchi];
}


Foam::tmp<Foam::volScalarField> Foam::basicThermoModel::alphaEff
(
...
Foam::tmp<Foam::scalarField> Foam::basicThermoModel::alphaEff
(
...
Foam::tmp<Foam::volScalarField> Foam::basicThermoModel::alphahe() const
{
    return volScalarField::New
    (
        "alphahe",
...
Foam::tmp<Foam::volScalarField> Foam::basicThermoModel::kappa() const
{
    return volScalarField::New
    (
        "kappa",
...
Foam::tmp<Foam::scalarField>
Foam::basicThermoModel::kappa(const label patchi) const
{
    return Cp(patchi)*alpha_.boundaryField()[patchi];
}


Foam::scalar Foam::basicThermoModel::kappai(const label celli) const
{
    return this->Cpi(celli)*alpha_[celli];
}


Foam::tmp<Foam::volScalarField> Foam::basicThermoModel::kappaEff
(
    const volScalarField& alphat
) const
{
