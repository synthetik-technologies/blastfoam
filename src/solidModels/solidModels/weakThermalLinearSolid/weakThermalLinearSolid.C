...
#include "weakThermalLinearSolid.H"
#include "volFields.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(weakThermalLinearSolid, 0);
addToRunTimeSelectionTable(solidModel, weakThermalLinearSolid, dictionary);


// * * * * * * * * * * *  Private Member Functions * * * * * * * * * * * * * //

bool weakThermalLinearSolid::converged
(
    const int iCorr,
...
void weakThermalLinearSolid::readDict()
{
    solidModel::readDict();
...
bool weakThermalLinearSolid::evolve()
{
    ...
    linearTotalDisplacementSolid::evolve();
