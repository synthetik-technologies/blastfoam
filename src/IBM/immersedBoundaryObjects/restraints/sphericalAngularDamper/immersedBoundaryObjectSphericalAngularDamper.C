...
#include "immersedBoundaryObjectSphericalAngularDamper.H"
...
Foam::immersedBoundaryObjectRestraints::sphericalAngularDamper::
sphericalAngularDamper
(
    const polyMesh& mesh,
    const word& name,
...
void Foam::immersedBoundaryObjectRestraints::sphericalAngularDamper::restrain
(
...
bool Foam::immersedBoundaryObjectRestraints::sphericalAngularDamper::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void Foam::immersedBoundaryObjectRestraints::sphericalAngularDamper::write
(
    Ostream& os
) const
{
