...
Foam::scalar Foam::fluxSchemes::AUSMPlusUp::M1
(
    const scalar& M,
    const label sign
)
...
Foam::scalar Foam::fluxSchemes::AUSMPlusUp::M2
(
    const scalar& M,
    const label sign
)
...
Foam::scalar Foam::fluxSchemes::AUSMPlusUp::M4
(
    const scalar& M,
    const label sign,
    const scalar& beta
...
Foam::scalar Foam::fluxSchemes::AUSMPlusUp::P5
(
    const scalar& M,
    const label sign,
    const scalar& xi
...
void Foam::fluxSchemes::AUSMPlusUp::postUpdate()
{
    alphapOwn_.clear();
    alphapNei_.clear();
    alphaMaxf_.clear();
...
void Foam::fluxSchemes::AUSMPlusUp::preUpdate(const volScalarField& p)
{
