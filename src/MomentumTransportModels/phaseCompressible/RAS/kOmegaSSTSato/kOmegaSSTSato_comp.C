...
kOmegaSSTSato_comp<BasicMomentumTransportModel>::kOmegaSSTSato_comp
(
...
template<class BasicMomentumTransportModel>
bool kOmegaSSTSato_comp<BasicMomentumTransportModel>::read()
{
...
kOmegaSSTSato_comp<BasicMomentumTransportModel>::getDispersedPhases() const
{
...
template<class BasicMomentumTransportModel>
void kOmegaSSTSato_comp<BasicMomentumTransportModel>::correctNut
(
...
template<class BasicMomentumTransportModel>
void kOmegaSSTSato_comp<BasicMomentumTransportModel>::correct()
{
