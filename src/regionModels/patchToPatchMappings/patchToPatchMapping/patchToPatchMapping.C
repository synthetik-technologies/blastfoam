...
)
{
    ...
    (
        new List<remote>
        (
            patchToPatchTools::distributeAddressing(srcFacesMapPtr_())
        )
    );
    ...
    if (needPoints_)
    {
        ...
        (
            new List<remote>
            (
                patchToPatchTools::distributeAddressing(srcPointsMapPtr_())
            )
        );
    }
}
...
)
{
    ...
    else
    {
        ...
        if (needPoints_)
        {
            ...
            tgtFacesMapPtr_ =
                patchToPatchTools::constructDistributionMap(sendFaces);
            tgtPointsMapPtr_ =
                patchToPatchTools::constructDistributionMap(sendPoints);
        }
        else
        {
            tgtFacesMapPtr_ =
