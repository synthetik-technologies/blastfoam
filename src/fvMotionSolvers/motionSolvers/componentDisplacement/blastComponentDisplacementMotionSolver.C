...
#include "blastComponentDisplacementMotionSolver.H"
...
namespace Foam
{
    defineTypeNameAndDebug(blastComponentDisplacementMotionSolver, 0);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

Foam::direction Foam::blastComponentDisplacementMotionSolver::cmpt
(
    const word& cmptName
) const
{
...
Foam::blastComponentDisplacementMotionSolver::blastComponentDisplacementMotionSolver
(
    const word& name,
    const polyMesh& mesh,
...
void Foam::blastComponentDisplacementMotionSolver::movePoints(const pointField& p)
{
    // No local data to update
}


void Foam::blastComponentDisplacementMotionSolver::topoChange
(
...
void Foam::blastComponentDisplacementMotionSolver::mapMesh(const polyMeshMap& map)
{
...
void Foam::blastComponentDisplacementMotionSolver::distribute
(
