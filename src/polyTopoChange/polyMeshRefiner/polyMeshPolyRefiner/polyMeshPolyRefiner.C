...
namespace Foam
{
    defineTypeNameAndDebug(polyMeshPolyRefiner, 0);
    addToRunTimeSelectionTable(polyMeshRefiner, polyMeshPolyRefiner, polyMesh);
    addToRunTimeSelectionTable(polyMeshRefiner, polyMeshPolyRefiner, dictionary);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

Foam::labelList Foam::polyMeshPolyRefiner::selectUnrefinePoints
(
...
Foam::polyMeshPolyRefiner::polyMeshPolyRefiner(polyMesh& mesh)
:
...
Foam::polyMeshPolyRefiner::polyMeshPolyRefiner
(
    polyMesh& mesh,
...
void Foam::polyMeshPolyRefiner::readDict(const dictionary& dict)
{
...
bool Foam::polyMeshPolyRefiner::refine
(
