...
namespace finiteElements
{
    ...
    defineFE(tet4); addFE(tet4, msh, 4);
    defineFE(tet10); addFE(tet10, msh, 11);
    defineFE(tet20); addFE(tet20, msh, 29);
    defineFE(tet35); addFE(tet35, msh, 30);
    defineFE(tet56); addFE(tet56, msh, 31);
    defineFE(tet84); addFE(tet84, msh, 71);
    defineFE(tet120); addFE(tet120, msh, 72);
    defineFE(tet165); addFE(tet165, msh, 73);
    defineFE(tet220); addFE(tet220, msh, 74);
    defineFE(tet286); addFE(tet286, msh, 75);
}
}
    ...
    invT_()
{
    ...
    forAll(this->nodes_, nodei)
    {
        ...
        seg_.calcShape(ip.x(), shape_x.data());
        seg_.calcShape(ip.y(), shape_y.data());
        seg_.calcShape(ip.z(), shape_z.data());
        seg_.calcShape(1.0 - ip.x() - ip.y() - ip.z(), shape_l.data());
...
) const
{
    ...
    List<scalar> shape_l(seg_.calcShape(1.0 - pt.x() - pt.y() - pt.z()));
...
) const
{
    ...
    seg_.calcDShape(1.0 - pt.x() - pt.y() - pt.z(), shape_l, dshape_l);
