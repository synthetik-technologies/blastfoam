...
#include "immersedBoundaryObjectAxialAngularSpring.H"
...
void
Foam::immersedBoundaryObjectRestraints::axialAngularSpring::restrain
(
...
bool Foam::immersedBoundaryObjectRestraints::axialAngularSpring::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void Foam::immersedBoundaryObjectRestraints::axialAngularSpring::write
(
    Ostream& os
) const
{
