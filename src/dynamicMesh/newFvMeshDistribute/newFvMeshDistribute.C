...
#include "newFvMeshDistribute.H"
#include "PstreamCombineReduceOps.H"
#include "newFvMeshAdder.H"
...
defineTypeNameAndDebug(newFvMeshDistribute, 0);
...
void Foam::newFvMeshDistribute::inplaceRenumberWithFlip
(
...
Foam::labelList Foam::newFvMeshDistribute::select
(
...
void Foam::newFvMeshDistribute::checkEqualWordList
(
    const string& msg,
    const wordList& lst
)
...
Foam::wordList Foam::newFvMeshDistribute::mergeWordList(const wordList& procNames)
{
    List<wordList> allNames(Pstream::nProcs());
...
void Foam::newFvMeshDistribute::printMeshInfo(const fvMesh& mesh)
{
    Pout<< "Primitives:" << nl
...
void Foam::newFvMeshDistribute::printCoupleInfo
(
...
Foam::label Foam::newFvMeshDistribute::findInternalPatch() const
{
...
// non-processor patch.
Foam::autoPtr<Foam::mapPolyMesh> Foam::newFvMeshDistribute::deleteProcPatches
(
...
// Repatch the mesh.
Foam::autoPtr<Foam::mapPolyMesh> Foam::newFvMeshDistribute::repatch
(
...
// merge those points.
Foam::autoPtr<Foam::mapPolyMesh> Foam::newFvMeshDistribute::mergeSharedPoints
(
...
void Foam::newFvMeshDistribute::getCouplingData
(
...
void Foam::newFvMeshDistribute::subsetCouplingData
(
    const fvMesh& mesh,
...
void Foam::newFvMeshDistribute::findCouples
(
    const primitiveMesh& mesh,
    const labelList& sourceFace,
    const labelList& sourceProc,
...
Foam::labelList Foam::newFvMeshDistribute::mapBoundaryData
(
...
Foam::labelList Foam::newFvMeshDistribute::mapPointData
(
    const primitiveMesh& mesh,      // mesh after adding
    const mapAddedPolyMesh& map,
    const labelList& boundaryData0, // on mesh before adding
...
Foam::autoPtr<Foam::mapPolyMesh> Foam::newFvMeshDistribute::doRemoveCells
(
...
void Foam::newFvMeshDistribute::addProcPatches
(
...
Foam::labelList Foam::newFvMeshDistribute::getBoundaryPatch
(
...
void Foam::newFvMeshDistribute::sendMesh
(
    const label domain,
    const fvMesh& mesh,
...
Foam::autoPtr<Foam::fvMesh> Foam::newFvMeshDistribute::receiveMesh
(
    const label domain,
    const wordList& pointZoneNames,
    const wordList& faceZoneNames,
...
Foam::newFvMeshDistribute::newFvMeshDistribute(fvMesh& mesh)
:
    mesh_(mesh)
{}
...
Foam::labelList Foam::newFvMeshDistribute::countCells
(
    const labelList& distribution
)
{
...
Foam::autoPtr<Foam::mapDistributePolyMesh> Foam::newFvMeshDistribute::distribute
(
    const labelList& distribution
)
{
    ...
    forAll(nSendCells[Pstream::myProcNo()], recvProc)
    {
        ...
        )
        {
            ...
            newFvMeshSubset subsetter(mesh_);
    ...
    forAll(nSendCells, sendProc)
    {
        ...
        )
        {
            ...
            autoPtr<mapAddedPolyMesh> map = newFvMeshAdder::add
            (
                mesh_,
                domainMesh,
                couples,
