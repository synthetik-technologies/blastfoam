...
namespace phaseChangeModels
{
    ...
    addToRunTimeSelectionTable(phaseChangeModel, ZGB, phaseThermo);
    addToRunTimeSelectionTable(phaseChangeModel, ZGB, thermo);

    addToRunTimeSelectionTable(cavitationModel, ZGB, phaseThermo);
    addToRunTimeSelectionTable(cavitationModel, ZGB, thermo);
}
}
