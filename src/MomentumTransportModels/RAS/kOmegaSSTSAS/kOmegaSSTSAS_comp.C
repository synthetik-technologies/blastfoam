...
tmp<fvScalarMatrix> kOmegaSSTSAS_comp<BasicMomentumTransportModel>::Qsas
(
...
template<class BasicMomentumTransportModel>
kOmegaSSTSAS_comp<BasicMomentumTransportModel>::kOmegaSSTSAS_comp
(
...
template<class BasicMomentumTransportModel>
bool kOmegaSSTSAS_comp<BasicMomentumTransportModel>::read()
{
