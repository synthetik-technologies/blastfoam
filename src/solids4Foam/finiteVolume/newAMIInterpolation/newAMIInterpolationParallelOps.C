...
Foam::label Foam::newAMIInterpolation<SourcePatch, TargetPatch>::
calcDistribution
(
...
template<class SourcePatch, class TargetPatch>
Foam::label
Foam::newAMIInterpolation<SourcePatch, TargetPatch>::calcOverlappingProcs
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newAMIInterpolation<SourcePatch, TargetPatch>::distributePatches
(
...
Foam::newAMIInterpolation<SourcePatch, TargetPatch>::calcProcMap
(
    const SourcePatch& srcPatch,
    const TargetPatch& tgtPatch
) const
