...
template<class Type>
bool Foam::blastSampledSurface::checkFieldSize(const Field<Type>& field) const
{
...
template<class Type>
Type Foam::blastSampledSurface::integrate(const Field<Type>& field) const
{
    Type value = Zero;
...
template<class Type>
Type Foam::blastSampledSurface::integrate(const tmp<Field<Type>>& field) const
{
...
template<class Type>
Type Foam::blastSampledSurface::average(const Field<Type>& field) const
{
    Type value = Zero;
...
template<class Type>
Type Foam::blastSampledSurface::average(const tmp<Field<Type>>& field) const
{
...
void Foam::blastSampledSurface::project
(
...
Foam::blastSampledSurface::project
(
    const tmp<Field<Type>>& field
) const
{
...
Foam::blastSampledSurface::pointAverage
(
