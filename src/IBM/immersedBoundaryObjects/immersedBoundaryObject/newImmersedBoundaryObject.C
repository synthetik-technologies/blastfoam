...
{
    word ibmType(dict.lookup("type"));

    Info<< "Selecting immersedBoundaryObject for "
        << dict.dictName() << ": " << ibmType << endl;
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown immersedBoundaryObject type "
            << ibmType << endl << endl
            << "Valid immersedBoundaryObject types are : " << endl
