...
#include "relaxationReactionRateFlameAreaModel.H"
...
:
    reactionRateFlameAreaModel(modelType, dict, mesh, combModel),
...
{
    if (reactionRateFlameAreaModel::read(dict))
    {
