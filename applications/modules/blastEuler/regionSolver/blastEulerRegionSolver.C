...
#include "blastEulerRegionSolver.H"
...
namespace regionSolvers
{
    ...
    addToRunTimeSelectionTable(regionSolver, blastEuler, dictionary);
}
}
...
Foam::regionSolvers::blastEuler::blastEuler
(
    fvMesh& mesh,
...
bool Foam::regionSolvers::blastEuler::changeMesh()
{
...
void Foam::regionSolvers::blastEuler::solve()
{
...
Foam::scalar Foam::regionSolvers::blastEuler::CoNum() const
{
...
Foam::scalar Foam::regionSolvers::blastEuler::maxCo() const
{
