...
namespace finiteElements
{
    ...
    defineFE(hex8); addFE(hex8, msh, 5);
    defineFE(hex27); addFE(hex27, msh, 12);
    defineFE(hex64); addFE(hex64, msh, 92);
    defineFE(hex125); addFE(hex125, msh, 93);
    defineFE(hex216); addFE(hex216, msh, 94);
    defineFE(hex343); addFE(hex343, msh, 95);
    defineFE(hex512); addFE(hex512, msh, 96);
    defineFE(hex729); addFE(hex729, msh, 97);
    defineFE(hex1000); addFE(hex1000, msh, 98);
}
}
