...
namespace finiteElements
{
    ...
    defineFE(tri3); addFE(tri3, msh, 2);
    defineFE(tri6); addFE(tri6, msh, 9);
    defineFE(tri10); addFE(tri10, msh, 21);
    defineFE(tri15); addFE(tri15, msh, 23);
    defineFE(tri21); addFE(tri21, msh, 25);
    defineFE(tri28); addFE(tri28, msh, 42);
    defineFE(tri36); addFE(tri36, msh, 43);
    defineFE(tri45); addFE(tri45, msh, 44);
    defineFE(tri55); addFE(tri55, msh, 45);
    defineFE(tri66); addFE(tri66, msh, 46);
}
}
    ...
    invT_()
{
    ...
    forAll(this->nodes_, nodei)
    {
        ...
        seg_.calcShape(1.0 - ip.x() - ip.y(), shape_l.data());
...
) const
{
    ...
    List<scalar> shape_l(seg_.calcShape(1.0 - pt.x() - pt.y()));
...
) const
{
    ...
    seg_.calcDShape(1.0 - pt.x() - pt.y(), shape_l, dshape_l);
