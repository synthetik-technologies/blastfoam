...
#include "blastFvMeshDistribute.H"
...
namespace Foam
{
    defineTypeNameAndDebug(blastFvMeshDistribute, 0);
...
void Foam::blastFvMeshDistribute::inplaceRenumberWithFlip
(
...
Foam::labelList Foam::blastFvMeshDistribute::select
(
...
void Foam::blastFvMeshDistribute::checkEqualWordList
(
    const string& msg,
    const wordList& lst
)
...
Foam::wordList Foam::blastFvMeshDistribute::mergeWordList(const wordList& procNames)
{
    List<wordList> allNames(Pstream::nProcs());
...
void Foam::blastFvMeshDistribute::printMeshInfo(const fvMesh& mesh)
{
    Pout<< "Primitives:" << nl
...
void Foam::blastFvMeshDistribute::printCoupleInfo
(
...
Foam::label Foam::blastFvMeshDistribute::findNonEmptyPatch() const
{
...
// non-processor patch.
Foam::autoPtr<Foam::mapPolyMesh> Foam::blastFvMeshDistribute::deleteProcPatches
(
...
// Repatch the mesh.
Foam::autoPtr<Foam::mapPolyMesh> Foam::blastFvMeshDistribute::repatch
(
...
// merge those points.
Foam::autoPtr<Foam::mapPolyMesh> Foam::blastFvMeshDistribute::mergeSharedPoints
(
...
void Foam::blastFvMeshDistribute::getCouplingData
(
...
void Foam::blastFvMeshDistribute::subsetCouplingData
(
    const fvMesh& mesh,
...
void Foam::blastFvMeshDistribute::findCouples
(
    const primitiveMesh& mesh,
    const labelList& sourceFace,
    const labelList& sourceProc,
...
Foam::labelList Foam::blastFvMeshDistribute::mapBoundaryData
(
...
Foam::labelList Foam::blastFvMeshDistribute::mapPointData
(
    const primitiveMesh& mesh,      // mesh after adding
    const mapAddedPolyMesh& map,
    const labelList& boundaryData0, // on mesh before adding
...
Foam::autoPtr<Foam::mapPolyMesh> Foam::blastFvMeshDistribute::doRemoveCells
(
...
void Foam::blastFvMeshDistribute::addProcPatches
(
...
Foam::labelList Foam::blastFvMeshDistribute::getBoundaryPatch
(
...
void Foam::blastFvMeshDistribute::sendMesh
(
    const label domain,
    const fvMesh& mesh,
...
Foam::autoPtr<Foam::fvMesh> Foam::blastFvMeshDistribute::receiveMesh
(
    const label domain,
    const wordList& pointZoneNames,
    const wordList& faceZoneNames,
...
Foam::blastFvMeshDistribute::blastFvMeshDistribute(fvMesh& mesh, const scalar mergeTol)
:
    mesh_(mesh),
    mergeTol_(mergeTol)
{}
...
Foam::labelList Foam::blastFvMeshDistribute::countCells
(
    const labelList& distribution
)
{
...
Foam::autoPtr<Foam::mapDistributePolyMesh> Foam::blastFvMeshDistribute::distribute
(
    const labelList& distribution
)
{
    ...
    forAll(nSendCells[Pstream::myProcNo()], recvProc)
    {
        ...
        )
        {
            ...
            blastFvMeshSubset subsetter(mesh_);
