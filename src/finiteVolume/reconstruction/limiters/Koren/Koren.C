...
namespace Foam
{
    makeLimitedSurfaceInterpolationScheme(Koren, KorenLimiter)
    makeLimitedVSurfaceInterpolationScheme(KorenV, KorenLimiter)
    ...
    makeMUSCLReconstruction(Linear, "linearMUSCL", Koren, KorenLimiter)
    ...
    makeMUSCLReconstruction(Quadratic, "quadraticMUSCL", Koren, KorenLimiter)
    makeLMUSCLReconstruction
    (
        Quadratic,
        "quadraticMUSCL",
