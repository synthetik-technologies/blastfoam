...
#include "blastGreyDiffusiveRadiationMixedFvPatchScalarField.H"
...
Foam::blastGreyDiffusiveRadiationMixedFvPatchScalarField::
blastGreyDiffusiveRadiationMixedFvPatchScalarField
(
    const fvPatch& p,
...
blastGreyDiffusiveRadiationMixedFvPatchScalarField
(
    const blastGreyDiffusiveRadiationMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::blastGreyDiffusiveRadiationMixedFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::blastGreyDiffusiveRadiationMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
