...
void Foam::newDirectAMI<SourcePatch, TargetPatch>::appendToDirectSeeds
(
    labelList& mapFlag,
...
template<class SourcePatch, class TargetPatch>
void Foam::newDirectAMI<SourcePatch, TargetPatch>::restartAdvancingFront
(
    labelList& mapFlag,
    DynamicList<label>& nonOverlapFaces,
    label& srcFacei,
...
template<class SourcePatch, class TargetPatch>
Foam::newDirectAMI<SourcePatch, TargetPatch>::newDirectAMI
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newDirectAMI<SourcePatch, TargetPatch>::calculate
(
