...
Foam::standardMUSCLReconstructionScheme<Type>::lookupOrConstruct
(
...
template<class Type>
Foam::standardMUSCLReconstructionScheme<Type>::standardMUSCLReconstructionScheme
(
...
Foam::standardMUSCLReconstructionScheme<Type>::interpolateOwn() const
{
...
template<class Type>
Foam::tmp<Foam::GeometricField<Type, Foam::fvsPatchField, Foam::surfaceMesh>>
Foam::standardMUSCLReconstructionScheme<Type>::interpolateNei() const
{
