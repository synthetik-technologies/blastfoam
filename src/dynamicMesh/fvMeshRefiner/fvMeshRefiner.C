...
void Foam::fvMeshRefiner::calculateProtectedCells
(
...
/*
Foam::scalarField
Foam::fvMeshRefiner::minCellField(const volScalarField& vFld) const
{
    ...
    if (force_)
    {
        forAll(markedCell, celli)
        {
            ...
            (
             ...
             && (maxRefinement[celli] > meshCutter_->cellLevel()[celli] || !isTop)
            )
            {
...
void Foam::fvMeshRefiner::checkEightAnchorPoints
(
...
void Foam::fvMeshRefiner::setProtectedCells()
{
    const labelList& cellLevel = meshCutter_->cellLevel();
    const labelList& pointLevel = meshCutter_->pointLevel();
...
void Foam::fvMeshRefiner::mapFields(const mapPolyMesh& mpm)
{}
