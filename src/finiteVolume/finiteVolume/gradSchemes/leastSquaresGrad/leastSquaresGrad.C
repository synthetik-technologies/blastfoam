...
#include "leastSquaresGrad_mod.H"
#include "leastSquaresVectors_mod.H"
#include "gaussGrad.H"
#include "fvMesh.H"
#include "volMesh.H"
...
<
    ...
    >
>
Foam::fv::leastSquaresGrad_mod<Type>::calcGrad
(
...
) const
{
    ...
    const leastSquaresVectors_mod& lsv = leastSquaresVectors_mod::New(mesh);
