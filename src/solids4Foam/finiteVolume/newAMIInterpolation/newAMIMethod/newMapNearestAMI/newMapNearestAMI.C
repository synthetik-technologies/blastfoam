...
void Foam::newMapNearestAMI<SourcePatch, TargetPatch>::findNearestFace
(
...
template<class SourcePatch, class TargetPatch>
void Foam::newMapNearestAMI<SourcePatch, TargetPatch>::setNextNearestFaces
(
    boolList& mapFlag,
    label& startSeedI,
    label& srcFacei,
...
template<class SourcePatch, class TargetPatch>
Foam::label Foam::newMapNearestAMI<SourcePatch, TargetPatch>::findMappedSrcFace
(
...
template<class SourcePatch, class TargetPatch>
Foam::newMapNearestAMI<SourcePatch, TargetPatch>::newMapNearestAMI
(
    const SourcePatch& srcPatch,
    const TargetPatch& tgtPatch,
...
template<class SourcePatch, class TargetPatch>
void Foam::newMapNearestAMI<SourcePatch, TargetPatch>::calculate
(
