...
#include "updatedLagrangianSolid.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(updatedLagrangianSolid, 0);
addToRunTimeSelectionTable
(
    solidModel, updatedLagrangianSolid, dictionary
);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

updatedLagrangianSolid::updatedLagrangianSolid(dynamicFvMesh& mesh)
:
    UpdatedLagrangianGeomSolid<incrementalSolid>(typeName, mesh)
{
