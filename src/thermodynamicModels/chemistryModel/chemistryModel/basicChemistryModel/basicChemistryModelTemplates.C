...
)
{
    ...
    if (cstrIter == cstrTable->end())
    {
        ...
        thisCmpts.append(basicThermoModel::splitThermoName(thermo.thermoName(), 5));
        ...
        forAll(names, i)
        {
            const wordList cmpts(basicThermoModel::splitThermoName(names[i], 8));
        ...
        forAll(names, i)
        {
            validCmpts.append(basicThermoModel::splitThermoName(names[i], 8));
        }
