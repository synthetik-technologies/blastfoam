...
template<class Type>
void Foam::CodedMultivariateEquation<Type>::prepare
(
    dynamicCode& dynCode,
...
) const
{
    ...
    dynCode.addCopyFile(codeTemplateH("CodedMultivariateEquation"));
...
template<class Type>
void Foam::CodedMultivariateEquation<Type>::clearRedirect() const
{
...
{
    this->updateLibrary();
    return multivariateEquation<Type>::New(codeName(), codeDict());
}


template<class Type>
const Foam::dictionary&
Foam::CodedMultivariateEquation<Type>::expandCodeDict
(
