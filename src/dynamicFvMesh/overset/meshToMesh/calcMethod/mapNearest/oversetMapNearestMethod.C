...
#include "oversetMapNearestMethod.H"
...
namespace Foam
{
    defineTypeNameAndDebug(oversetMapNearestMethod, 0);
    addToRunTimeSelectionTable(oversetMeshToMeshMethod, oversetMapNearestMethod, meshComponents);
}

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

bool Foam::oversetMapNearestMethod::findInitialSeeds
(
...
void Foam::oversetMapNearestMethod::calculateAddressing
(
...
void Foam::oversetMapNearestMethod::findNearestCell
(
...
void Foam::oversetMapNearestMethod::setNextNearestCells
(
    label& startSeedI,
    label& srcCelli,
    label& tgtCelli,
...
Foam::label Foam::oversetMapNearestMethod::findMappedSrcCell
(
...
Foam::oversetMapNearestMethod::oversetMapNearestMethod
(
    const polyMesh& src,
    const polyMesh& tgt
)
...
void Foam::oversetMapNearestMethod::calculate
(
