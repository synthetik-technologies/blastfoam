...
void Foam::coupledGlobalPolyPatch::movePointsOther(const bool clear) const
{}


void Foam::coupledGlobalPolyPatch::distribute(const polyDistributionMap&)
{
    clearOut();
    samplePatch().distributeOther();
}


void Foam::coupledGlobalPolyPatch::distributeOther() const
{}


void Foam::coupledGlobalPolyPatch::topoChange(const polyTopoChangeMap&)
{
    clearOut();
    samplePatch().topoChangeOther();
}


void Foam::coupledGlobalPolyPatch::topoChangeOther() const
{}


void Foam::coupledGlobalPolyPatch::mapMesh(const polyMeshMap&)
{
    clearOut();
    samplePatch().mapMeshOther();
}


void Foam::coupledGlobalPolyPatch::mapMeshOther() const
{}
