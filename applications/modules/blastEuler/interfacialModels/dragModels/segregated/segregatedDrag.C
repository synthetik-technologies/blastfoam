...
Foam::tmp<Foam::volScalarField> Foam::dragModels::segregated::stabK() const
{
    return K();
}


Foam::tmp<Foam::surfaceScalarField> Foam::dragModels::segregated::stabKf() const
{
    return Kf();
}


Foam::scalar Foam::dragModels::segregated::cellStabK(const label celli) const
{
    return cellK(celli);
}
