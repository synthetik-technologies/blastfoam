...
#include "axialAngularSpringObjectMotionRestraint.H"
...
void
Foam::objectMotionRestraints::axialAngularSpring::restrain
(
...
bool Foam::objectMotionRestraints::axialAngularSpring::read
(
    const dictionary& dict
)
{
...
void Foam::objectMotionRestraints::axialAngularSpring::write
(
    Ostream& os
) const
{
