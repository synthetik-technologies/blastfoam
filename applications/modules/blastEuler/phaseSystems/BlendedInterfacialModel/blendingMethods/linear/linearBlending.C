...
Foam::scalar Foam::blendingMethods::linear::f1i
(
    const label celli,
    const phaseModel& phase1,
    const phaseModel& phase2
...
{
    const scalar
        minFullAlpha(minFullyContinuousAlpha_[phase2.name()].value());
    const scalar
        minPartAlpha(minPartlyContinuousAlpha_[phase2.name()].value());
...
Foam::scalar Foam::blendingMethods::linear::f2i
(
    const label celli,
    const phaseModel& phase1,
    const phaseModel& phase2
...
{
    const scalar
        minFullAlpha(minFullyContinuousAlpha_[phase1.name()].value());
    const scalar
        minPartAlpha(minPartlyContinuousAlpha_[phase1.name()].value());
