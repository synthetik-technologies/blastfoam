...
#include "laminarBlastCombustionModel.H"
#include "fvmSup.H"
...
namespace combustionModels
{
    ...
    addToRunTimeSelectionTable(blastCombustionModel, laminar, fluid);
    addToRunTimeSelectionTable(blastCombustionModel, laminar, solid);
}
}
...
:
    ...
    chemistryPtr_
    (
        blastChemistryModel::New
        (
            dynamicCast<const blastThermo&>(thermo)
        )
    )
{
