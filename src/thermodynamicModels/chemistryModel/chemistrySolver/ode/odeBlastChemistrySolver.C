...
Foam::odeBlastChemistrySolver<ChemistryModel>::odeBlastChemistrySolver
(
    const blastThermo& thermo
)
:
    blastChemistrySolver<ChemistryModel>(thermo),
...
template<class ChemistryModel>
void Foam::odeBlastChemistrySolver<ChemistryModel>::solve
(
    scalar& p,
    scalar& T,
    scalarField& c,
...
) const
{
    ...
    if (debug)
    {
        ...
        cTp_[nSpecie] = 300*rootSmall;
        cTp_[nSpecie+1] = 1e5*rootSmall;
