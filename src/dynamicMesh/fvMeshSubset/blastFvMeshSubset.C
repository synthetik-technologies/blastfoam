...
bool Foam::blastFvMeshSubset::checkCellSubset() const
{
    if (blastFvMeshSubsetPtr_.empty())
    {
...
void Foam::blastFvMeshSubset::markPoints
(
...
void Foam::blastFvMeshSubset::doCoupledPatches
(
    const bool syncPar,
...
labelList Foam::blastFvMeshSubset::subset
(
    const label nElems,
...
void Foam::blastFvMeshSubset::subsetZones()
{
    ...
    forAll(pointZones, i)
    {
        ...
        (
            ...
            i,
            blastFvMeshSubsetPtr_().pointZones()
        );
    }
    ...
    forAll(faceZones, i)
    {
        ...
        (
            ...
            subFlipStatus,
            i,
            blastFvMeshSubsetPtr_().faceZones()
        );
    }
    ...
    forAll(cellZones, i)
    {
        ...
        (
            ...
            i,
            blastFvMeshSubsetPtr_().cellZones()
        );
    }


    // Add the zones
    blastFvMeshSubsetPtr_().addZones(pZonePtrs, fZonePtrs, cZonePtrs);
}


Foam::labelList Foam::blastFvMeshSubset::getCellsToRemove
(
...
Foam::blastFvMeshSubset::blastFvMeshSubset(const fvMesh& baseMesh)
:
    baseMesh_(baseMesh),
    blastFvMeshSubsetPtr_(nullptr),
    pointMap_(0),
    faceMap_(0),
    cellMap_(0),
    patchMap_(0),
...
void Foam::blastFvMeshSubset::setCellSubset
(
...
)
{
    ...
    // Delete any old mesh
    blastFvMeshSubsetPtr_.clear();
    // Make a new mesh
    blastFvMeshSubsetPtr_.reset
    (
        new fvMesh
        (
            IOobject
    ...
    forAll(oldPatches, patchi)
    {
        if (boundaryPatchSizes[patchi] > 0)
        {
            ...
            (
                blastFvMeshSubsetPtr_().boundaryMesh(),
                nNewPatches,
    ...
    // Add the fvPatches
    blastFvMeshSubsetPtr_().addFvPatches(newBoundary);
...
void Foam::blastFvMeshSubset::setLargeCellSubset
(
    const labelList& region,
    const label currentRegion,
    const label patchID,
...
)
{
    ...
    // Add the fvPatches
    blastFvMeshSubsetPtr_().addFvPatches(newBoundary, syncPar);
...
Foam::labelList Foam::blastFvMeshSubset::getExposedFaces
(
    const labelList& region,
    const label currentRegion,
...
bool Foam::blastFvMeshSubset::hasSubMesh() const
{
    return blastFvMeshSubsetPtr_.valid();
}


const fvMesh& Foam::blastFvMeshSubset::subMesh() const
{
    checkCellSubset();

    return blastFvMeshSubsetPtr_();
}


fvMesh& Foam::blastFvMeshSubset::subMesh()
{
    checkCellSubset();
...
const labelList& Foam::blastFvMeshSubset::pointMap() const
{
    checkCellSubset();
...
const labelList& Foam::blastFvMeshSubset::faceMap() const
{
    checkCellSubset();
...
const labelList& Foam::blastFvMeshSubset::faceFlipMap() const
{
...
const labelList& Foam::blastFvMeshSubset::cellMap() const
{
    checkCellSubset();
...
const labelList& Foam::blastFvMeshSubset::patchMap() const
{
    checkCellSubset();
