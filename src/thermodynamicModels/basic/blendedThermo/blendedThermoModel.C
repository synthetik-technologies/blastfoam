...
template<class Method1, class Method2, class ... Args>
Foam::tmp<Foam::volScalarField>
Foam::blendedThermoModel<BasicThermo, Thermo1, Thermo2>::blendedVolScalarFieldPropertySqr
(
    const word& psiName,
    const dimensionSet& psiDim,
    Method1 psiMethod1,
    ...
    forAll(this->p_, celli)
    {
        ...
        else
        {
            psi[celli] =
                sqrt
                (
                    sqr((this->*psiMethod2)(args[celli] ...))*x
                  + sqr((this->*psiMethod1)(args[celli] ...))
                   *(1.0 - x)
                );
        }
    }
...
template<class Method1, class Method2, class ... Args>
Foam::tmp<Foam::scalarField>
Foam::blendedThermoModel<BasicThermo, Thermo1, Thermo2>::blendedCellSetPropertySqr
(
    Method1 psiMethod1,
    Method2 psiMethod2,
    const labelList& cells,
...
template<class Method1, class Method2, class ... Args>
Foam::tmp<Foam::scalarField>
Foam::blendedThermoModel<BasicThermo, Thermo1, Thermo2>::blendedPatchFieldPropertySqr
(
    Method1 psiMethod1,
    Method2 psiMethod2,
    const label patchi,
    ...
    forAll(this->p_.boundaryField()[patchi], facei)
    {
        ...
        else
        {
            psi[facei] =
                sqrt
                (
                    sqr((this->*psiMethod2)(args[facei] ...))
                   *x[facei]
                  + sqr((this->*psiMethod1)(args[facei] ...))
                    *(1.0 - x[facei])
                );
        }
    }
