...
void Foam::blastFvMeshDistribute::printFieldInfo(const fvMesh& mesh)
{
...
void Foam::blastFvMeshDistribute::saveBoundaryFields
(
...
template<class T, class Mesh>
void Foam::blastFvMeshDistribute::mapBoundaryFields
(
...
template<class T>
void Foam::blastFvMeshDistribute::saveInternalFields
(
...
template<class T>
void Foam::blastFvMeshDistribute::mapExposedFaces
(
    const mapPolyMesh& map,
...
)
{
    ...
    {
        FatalErrorIn("blastFvMeshDistribute::mapExposedFaces(..)") << "problem"
            << abort(FatalError);
    }
...
void Foam::blastFvMeshDistribute::initPatchFields
(
...
template<class GeoField>
void Foam::blastFvMeshDistribute::correctBoundaryConditions()
{
...
template<class GeoField>
void Foam::blastFvMeshDistribute::sendFields
(
    const label domain,
    const wordList& fieldNames,
    const blastFvMeshSubset& subsetter,
    Ostream& toNbr
)
{
...
template<class GeoField>
void Foam::blastFvMeshDistribute::receiveFields
(
    const label domain,
    const wordList& fieldNames,
