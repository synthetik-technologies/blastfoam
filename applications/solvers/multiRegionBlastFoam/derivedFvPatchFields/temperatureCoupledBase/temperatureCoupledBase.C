...
) const
{
    ...
    switch (method_)
    {
        case mtFluidThermo:
        {
            typedef fiveEqnCompressibleTurbulenceModel turbulenceModel;
            ...
            else if (mesh.foundObject<fluidThermoModel>("fluidThermo"))
            {
        ...
        case mtSolidThermo:
        {
            const solidThermoModel& thermo =
                mesh.lookupObject<solidThermoModel>("solidThermo");
