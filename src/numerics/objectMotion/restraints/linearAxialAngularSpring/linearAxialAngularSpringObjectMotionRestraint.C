...
#include "linearAxialAngularSpringObjectMotionRestraint.H"
...
Foam::objectMotionRestraints::linearAxialAngularSpring::
linearAxialAngularSpring
(
    const word& name,
...
void
Foam::objectMotionRestraints::linearAxialAngularSpring::restrain
(
...
bool Foam::objectMotionRestraints::linearAxialAngularSpring::read
(
    const dictionary& dict
)
{
...
void Foam::objectMotionRestraints::linearAxialAngularSpring::write
(
    Ostream& os
) const
{
