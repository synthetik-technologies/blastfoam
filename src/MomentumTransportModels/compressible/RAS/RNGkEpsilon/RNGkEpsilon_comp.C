...
tmp<volScalarField> RNGkEpsilon_comp<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_comp<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> RNGkEpsilon_comp<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
RNGkEpsilon_comp<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
RNGkEpsilon_comp<BasicMomentumTransportModel>::RNGkEpsilon_comp
(
...
template<class BasicMomentumTransportModel>
bool RNGkEpsilon_comp<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_comp<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
